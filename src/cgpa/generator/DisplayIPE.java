 ...
 * @author SCC
 */
public class DisplayIPE extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("IPE Dept. Website");
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        else if(jComboBox1.getSelectedItem() == " 2nd year, 1st semester (2.1)")
        {
            ...
            new DataInput2().setVisible(true);
            Credit.setTotal_credit(19.5);
            Credit.setDept("Dept. I.P.E., 2nd year, 1st semester");
        }
        else if(jComboBox1.getSelectedItem() == " 2nd year, 2nd semester (2.2)")
        {
            ...
            new DataInput2().setVisible(true);
            Credit.setTotal_credit(19.5);
            Credit.setDept("Dept. I.P.E., 2nd year, 2nd semester");
        }
        else if(jComboBox1.getSelectedItem() == " 2nd year, 1st semester (2.1)")
        {
            this.setVisible(false);
        ...
        else if(jComboBox1.getSelectedItem() == " 3rd year, 1st semester (3.1)")
        {
            ...
            new DataInput2().setVisible(true);
            Credit.setTotal_credit(19.5);
            Credit.setDept("Dept. I.P.E., 3rd year, 1st semester");
        }
        else if(jComboBox1.getSelectedItem() == " 3rd year, 2nd semester (3.2)")
        {
            ...
            new DataInput2().setVisible(true);
            Credit.setTotal_credit(19.5);
            Credit.setDept("Dept. I.P.E., 3rd year, 2nd semester");
        }
        else if(jComboBox1.getSelectedItem() == " 4th year, 1st semester (4.1)")
        {
            //new DataInput3("Dept. I.P.E. , 4th year, 1st semester (4.1)");
            new DataInput3().setVisible(true);
            this.setVisible(false);
            Credit.setTotal_credit(19.5);
            Credit.setDept("Dept. I.P.E., 4th year, 1st semester");
        }
        else if(jComboBox1.getSelectedItem() == " 4th year, 2nd semester (4.2)")
        {
            new DataInput3().setVisible(true);
            this.setVisible(false);
            Credit.setTotal_credit(18);
            Credit.setDept("Dept. I.P.E., 4th year, 2nd semester");
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            // TODO add your handling code here:
            Desktop.getDesktop().browse(new URL("https://www.aust.edu/mpe").toURI());
        } catch (Exception e) {}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DisplayIPE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
