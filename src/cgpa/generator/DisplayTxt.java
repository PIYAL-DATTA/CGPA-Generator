 ...
 * @author SCC
 */
public class DisplayTxt extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("TE Dept. Website");
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        {  
            ...
            Credit.setDept("Dept. TXT., 1st year, 1st semester");
        }
        else if(jComboBox1.getSelectedItem() == " 1st year, 2nd semester (1.2)")
        {
            ...
            Credit.setDept("Dept. TXT., 1st year, 2nd semester");
        }
        if(jComboBox1.getSelectedItem() == " 2nd year, 1st semester (2.1)")
        {  
            this.setVisible(false);
            new DataInput5().setVisible(true);
            Credit.setTotal_credit(19.5);
            Credit.setDept("Dept. TXT., 2nd year, 1st semester");
        }
        else if(jComboBox1.getSelectedItem() == " 2nd year, 2nd semester (2.2)")
        {
            this.setVisible(false);
            new DataInput4().setVisible(true);
            Credit.setTotal_credit(21.5);
            Credit.setDept("Dept. TXT., 2nd year, 2nd semester");
        }
        else if(jComboBox1.getSelectedItem() == " 3rd year, 1st semester (3.1)")
        {
            this.setVisible(false);
            new DataInput2().setVisible(true);
            Credit.setTotal_credit(20);
            Credit.setDept("Dept. TXT., 3rd year, 1st semester");
        }
        if(jComboBox1.getSelectedItem() == " 3rd year, 2nd semester (3.2)")
        {  
            this.setVisible(false);
            new DataInput5().setVisible(true);
            Credit.setTotal_credit(19.5);
            Credit.setDept("Dept. TXT., 3rd year, 2nd semester");
        }
        else if(jComboBox1.getSelectedItem() == " 4th year, 1st semester (4.1)")
        {
            new DataInput5().setVisible(true);
            this.setVisible(false);
            Credit.setTotal_credit(16.5);
            Credit.setDept("Dept. TXT., 4th year, 1st semester");
        }
        else if(jComboBox1.getSelectedItem() == " 4th year, 2nd semester (4.2)")
        {
            ...
            this.setVisible(false);
            Credit.setTotal_credit(21.5);
            Credit.setDept("Dept. TXT., 4th year, 2nd semester");
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            // TODO add your handling code here:
            Desktop.getDesktop().browse(new URL("https://www.aust.edu/te").toURI());
        } catch (Exception e) {}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DisplayTxt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
