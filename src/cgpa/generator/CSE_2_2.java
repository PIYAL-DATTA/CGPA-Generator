 ...
 * @author SCC
 */
public class CSE_2_2 extends javax.swing.JFrame {
    ...
    public void cheak(String str){
       try {
                ...
                JOptionPane.showMessageDialog(CSE_2_2.this, "Enter value / proper value", "ERROR", 0);
                Mushroof = 0;
            }
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(g1 == 0 || g2 == 0 ||g3 == 0 || g4 == 0 || g5 == 0 || g6 == 0 || g7 == 0 || g8 == 0 || g9 == 0)
        {
            ...
            {
                JOptionPane.showMessageDialog(CSE_2_2.this, "Enter proper value", "ERROR", 0);
            }
        ...
        {
        //Grade calculation
        double cgpa = (g1*3.00 + g2*3.00 + g3*3.00 + g4*3.00 + g5*3.00 + g6*1.5 + g7*1.5 + g8*0.75 + g9*0.75)/getTotal_credit();
        ...
        try {
            ...
            ps.setString(3, "Dept. C.S.E., 2nd year, 2nd semester");
            
            ps.executeUpdate();

        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(CSE_2_2.this, "Something wrong. Try Again", "ERROR", 0);
    }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CSE_2_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
