 ...
 * @author SCC
 */
public class CSE_4_1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Option 1 (LAB) : ");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 270, -1, -1));
        getContentPane().add(jTextField10, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 270, 104, -1));
        getContentPane().add(jTextField11, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 310, 100, -1));

        jLabel13.setText("Option 2 (LAB) : ");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 310, -1, -1));

        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cgpa/generator/BG1_1.jpg"))); // NOI18N
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -6, 620, 420));
    ...
    public void cheak(String str){
       try {
                ...
                JOptionPane.showMessageDialog(CSE_4_1.this, "Enter value / proper value", "ERROR", 0);
                Mushroof = 0;
            }
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        double n10 = Double.parseDouble(s10);
        ...
        //Fail cheaking
        if(g1 == 0 || g2 == 0 ||g3 == 0 || g4 == 0 || g5 == 0 || g6 == 0 || g7 == 0 || g8 == 0 || g9 == 0 || g10 == 10)
        {
            new Fail().setVisible(true);
            this.setVisible(false);
        }
        else if(n1 < 0 || n2 < 0 || n3 < 0 || n4 < 0 || n5 < 0 || n6 < 0 || n7 < 0 || n8 < 0 || n9 < 0 || g10 < 10)
            {
                JOptionPane.showMessageDialog(CSE_4_1.this, "Enter proper value", "ERROR", 0);
            }
        else if(n1 > 100 || n2 > 100 || n3 > 100 || n4 > 100 || n5 > 100 || n6 > 100 || n7 > 100 || n8 > 100 || n9 > 100 || g10 > 100)
            {
                JOptionPane.showMessageDialog(CSE_4_1.this, "Enter proper value", "ERROR", 0);
            }
        ...
        {
        //Grade calculation
        double cgpa = (g1*3.00 + g2*3.00 + g3*3.00 + g4*3.00 + g5*3.00 + g6*3 + g7*0.75 + g8*0.75 + g9*0.75 + g10*0.75)/getTotal_credit();
        ...
        try {
            ...
            ps.setString(3, "Dept. C.S.E., 4th year, 1st semester");
            
            ps.executeUpdate();

        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(CSE_4_1.this, "Something wrong. Try Again", "ERROR", 0);
    }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CSE_4_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
