 ...
 * @author SCC
 */
public class DisplayME extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("ME Dept. Website");
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        {  
            ...
            Credit.setDept("Dept. M.E., 1st year, 1st semester");
        }
        else if(jComboBox1.getSelectedItem() == " 1st year, 2nd semester (1.2)")
        {
            ...
            Credit.setDept("Dept. M.E., 1st year, 2nd semester");
        }
        else if(jComboBox1.getSelectedItem() == " 2nd year, 1st semester (2.1)")
        {
            ...
            new DataInput2().setVisible(true);
            Credit.setTotal_credit(19.5);
            Credit.setDept("Dept. M.E., 2nd year, 1st semester");
        }
        else if(jComboBox1.getSelectedItem() == " 2nd year, 2nd semester (2.2)")
        {
            ...
            new DataInput2().setVisible(true);
            Credit.setTotal_credit(19.5);
            Credit.setDept("Dept. M.E., 2nd year, 2nd semester");
        }
        else if(jComboBox1.getSelectedItem() == " 3rd year, 1st semester (3.1)")
        {
            ...
            new DataInput2().setVisible(true);
            Credit.setTotal_credit(19.5);
            Credit.setDept("Dept. M.E., 3rd year, 1st semester");
        }
        else if(jComboBox1.getSelectedItem() == " 3rd year, 2nd semester (3.2)")
        {
            ...
            new DataInput5().setVisible(true);
            Credit.setTotal_credit(19.5);
            Credit.setDept("Dept. M.E., 3rd year, 2nd semester");
        }
        else if(jComboBox1.getSelectedItem() == " 4th year, 1st semester (4.1)")
        {
            ...
            new DataInput5().setVisible(true);
            Credit.setTotal_credit(19.5);
            Credit.setDept("Dept. M.E., 4th year, 1st semester");
        }
        else if(jComboBox1.getSelectedItem() == " 4th year, 2nd semester (4.2)")
        {
            ...
            Credit.setDept("Dept. M.E., 4th year, 2nd semester");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DisplayME.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
