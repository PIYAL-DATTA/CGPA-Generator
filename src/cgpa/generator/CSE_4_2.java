 ...
 * @author SCC
 */
public class CSE_4_2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Option 3 (LAB) :");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 230, -1, -1));
    ...
    public void cheak(String str){
       try {
                ...
                JOptionPane.showMessageDialog(CSE_4_2.this, "Enter value / proper value", "ERROR", 0);
                Mushroof = 0;
            }
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        //Fail cheaking
        if(g1 == 0 || g2 == 0 ||g3 == 0 || g5 == 0 || g6 == 0 || g7 == 0 || g8 == 0 || g9 == 0)
        {
            new Fail().setVisible(true);
            this.setVisible(false);
        }
        else if(n1 < 0 || n2 < 0 || n3 < 0 || n5 < 0 || n6 < 0 || n7 < 0 || n8 < 0 || n9 < 0)
            {
                JOptionPane.showMessageDialog(CSE_4_2.this, "Enter proper value", "ERROR", 0);
            }
        else if(n1 > 100 || n2 > 100 || n3 > 100 || n5 > 100 || n6 > 100 || n7 > 100 || n8 > 100 || n9 > 100)
            {
                JOptionPane.showMessageDialog(CSE_4_2.this, "Enter proper value", "ERROR", 0);
            }
        ...
        {
        //Grade calculation
        double cgpa = (g1*3.00 + g2*3.00 + g3*3.00 + g5*3.00 + g6*3 + g7*0.75 + g8*0.75 + g9*0.75)/getTotal_credit();
        ...
        try {
            ...
            ps.setString(3, "Dept. C.S.E., 4th year, 2nd semester");
            
            ps.executeUpdate();

        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(CSE_4_2.this, "Something wrong. Try Again", "ERROR", 0);
    }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CSE_4_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
